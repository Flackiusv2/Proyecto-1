...
public class PersistenciaUsuarios {
    ...
    public JSONObject guardarAdminist Administrador){
    ...
    public static Galeria cargarUsuarios(Galeria galeria){
        ...
        JSONObject Administrador = raiz.getJSONObject("Administrador" = cargarAdministrador(Administrador, galeria);
        galer);
    ...
    p cargarAdministrador(JSONObject Administrador, Galeria galeria){
        ...
        String id = Administrador.getString("id" (login, password, rol, galeria, id);
        r;
    }
    ...
    public Empleado cargarEmpleado(JSONObject jEmpleado, Galeria galeria){
        ...
        if (rol.equals("operador")){
            return new Operador(login, password, rol, galeria, id);
        }
